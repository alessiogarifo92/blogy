...
@section('content')
    <div class="container">
        ...
        <div class="comment-form-wrap pt-5">
            ...
            <form action="{{ route('posts.update', $post->id) }}" method="POST" class="p-5 bg-light" enctype="multipart/form-data">
                @csrf

                <div class="form-group">
                    <label for="title">Title</label>
                    <input type="text" placeholder="title" name="title" value="{{$post->title}}" class="form-control" id="title">
                </div>
